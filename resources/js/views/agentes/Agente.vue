<template>
  ...
  <div>
          ...
          <div class="lg:flex justify-between">
            ...
            <div class="lg:block p-5">
              <div class="lg:hidden">
                ...
                <div class="border-t-2 tertiary-border w-2/12 my-5"></div>
              </div>
            ...
            <div class="lg:w-2/3 lg:mx-10 mx-auto">
              ...
              <div id="cards" class="flex flex-wrap">
                <div class="w-1/2 lg:w-1/3 rounded-lg primary text-white text-center p-3 m-1">
                ...
                <div class="w-1/2 lg:w-1/3 rounded-lg primary text-white text-center p-5 m-1">
    ...
    <!-- carrusel Ultimos ingresos -->
    <div>
      <div class="flex justify-center my-10">
        <w-btn :outlined="true" color="tertiary" class>
          <span class="body bold">ÚLTIMOS INGRESOS</span>
        </w-btn>
      </div>
      <div>
        <w-carousel
