      ...
      <div class="block">
        ...
        <div>
          ...
          <form class="block lg:w-4/5">
            <w-input :placeholder="'Ejemplo: https://www.youtube.com/watch?v=uN5Cux5t0Ak'"></w-input>
          </form>
        </div>
        <div>
          ...
          <div class="flex-wrap lg:flex lg:grid grid-cols-2 justify-around">
            <div class="bg-gray-300 rounded-lg mb-4 lg:mr-4 lg:mb-0">
              <div class="fileButton justify-center">
                ...
                <div class="caption white-text bold bg-blue-300 rounded-full">SELECCIONAR FOTOS</div>
                <div
            ...
            <div class="bg-gray-300 rounded-lg mt-4 lg:ml-4 lg:mt-0">
              <div class="fileButton justify-center">
                ...
                <div class="caption white-text bold bg-blue-300 rounded-full">SELECCIONAR VIDEO</div>
                <div
                  class="caption whitespace-normal opacity-75"
